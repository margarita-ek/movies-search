...
<h2>Задача работы</h2>
Получить содержимое базы данных (MongoDB), обработать на сервере (Node.js) и отправить на фронтенд (React.js), чтобы использовать массив данных при создании различных компонентов. 
<h2>Описание</h2>
